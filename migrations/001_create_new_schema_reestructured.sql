-- =====================================================
-- MIGRACIÓN COMPLETA - ESQUEMA REESTRUCTURADO PAMBAZO
-- Versión: 1.0
-- Fecha: 2025-10-02
-- Descripción: Creación del nuevo esquema de base de datos
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_inventory_entries_entry_type ON inventory_entries(entry_type);
CREATE INDEX IF NOT EXISTS idx_inventory_entries_created_at ON inventory_entries(created_at);
CREATE INDEX IF NOT EXISTS idx_inventory_entries_expiry_date ON inventory_entries(expiry_date);
...
DO $$
BEGIN
    RAISE NOTICE 'Esquema de base de datos reestructurado creado exitosamente';
    RAISE NOTICE 'Tablas creadas: users, categories, products, product_ingredients, tables, orders, order_items, inventory, suppliers, inventory_entries, table_reservations, audit_logs, notifications';
